 ...
 */
class Version20121118003311 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER TABLE famelo_demo_admin_domain_model_widgets ADD address VARCHAR(40) DEFAULT NULL, ADD date DATETIME NOT NULL, ADD time DATETIME NOT NULL, ADD datetime DATETIME NOT NULL, ADD textarea VARCHAR(255) NOT NULL, ADD password VARCHAR(255) NOT NULL");
	...
	public function down(Schema $schema) {
		...
		$this->addSql("ALTER TABLE famelo_demo_admin_domain_model_widgets DROP address, DROP date, DROP time, DROP datetime, DROP textarea, DROP password");
	}
}
