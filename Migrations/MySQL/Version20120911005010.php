 ...
 */
class Version20120911005010 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE demo_admin_domain_model_widgets (flow3_persistence_identifier VARCHAR(40) NOT NULL, address VARCHAR(40) DEFAULT NULL, string VARCHAR(255) NOT NULL, boolean TINYINT(1) NOT NULL, date DATETIME NOT NULL, time DATETIME NOT NULL, datetime DATETIME NOT NULL, textarea VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_D36A9387D4E6F81 (address), UNIQUE INDEX flow3_identity_demo_admin_domain_model_widgets (string), PRIMARY KEY(flow3_persistence_identifier)) ENGINE = InnoDB");
